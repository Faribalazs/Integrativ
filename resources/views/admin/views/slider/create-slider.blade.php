<x-admin-app-layout>
    <x-slot name="pageTitle">
        {{ __('app.admin.slider.create-title') }}
    </x-slot>
    ...
    <div class="main-container-admin w-full mt-10" style="overflow: auto">
        <form method="POST" class="w-full" enctype="multipart/form-data" action="{{ route('admin.slider.add.done') }}">
            ...
            <div class="flex flex-col">
                ...
                <input class="input-style {{ $errors->has('slider_name') ? 'border-error mb-1' : 'mb-3' }}"
                    name="slider_name" type="text" id="slider_name">
