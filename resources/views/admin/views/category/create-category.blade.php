<x-admin-app-layout>
    <x-slot name="pageTitle">
        {{ __('app.admin.category.create-title') }}
    </x-slot>
    ...
    <div class="main-container-admin w-full mt-10" style="overflow: auto">
        <form method="POST" class="w-full" enctype="multipart/form-data" action="{{ route('admin.category.add.done') }}">
            ...
            <div class="flex flex-col">
                ...
                <input class="input-style {{ $errors->has('category_name') ? 'border-error mb-1' : 'mb-3' }}"
                    name="category_name" type="text" id="category_name" >
             ...
             <div class="mt-3 flex flex-col">
                ...
                <input class="input-style {{ $errors->has('order') ? 'border-error mb-1' : 'mb-3' }}"
                    name="order" type="number" id="order">
            ...
            <div class="mt-3 flex flex-col">
                <label for="slug" class="sm:text-xl text-base my-3">{{ __('app.admin.category.url') }}
                    :</label>
                <input class="input-style {{ $errors->has('slug') ? 'border-error mb-1' : 'mb-3' }}"
                    name="slug" type="text" id="slug">
