...
<div class="swiper psychotherapistsSlider my-16">
    ...
    <div class="psychotherapists-swiper-pagination flex w-full justify-center mt-10"></div>
</div>
...
<script>
    const psychotherapistsSlider = new Swiper('.psychotherapistsSlider', {
        ...
        pagination: {
            el: '.psychotherapists-swiper-pagination',
            clickable: true,
        },
        autoplay: {
            delay: 2000,
